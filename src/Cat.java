...
public class Cat extends Animal {
    ...
    private static final int MOUSE_FOOD_VALUE = 35;
    // A shared random number generator to control breeding.
    private static final Random rand = Randomizer.getRandom();
    
    public HashMap<String, String> catData = new HashMap<>();
     ...
     */
    public void act(List<Animal> newCats) {
        incrementAge();
        incrementHunger();
        if (isAlive()) {
            giveBirth(newCats);
